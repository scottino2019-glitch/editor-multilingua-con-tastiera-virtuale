...
export default function App() {
  ...
  const handleExportPDF = async () => {
    try {
      // 1. Preload any attached images asynchronously to avoid blank pages and CORS canvas taint errors
      ...
      for (const m of imageLinks) {
        try {
          ...
          console.warn("Failed to load image with CORS anonymous, trying raw load:", m.url);
          try {
